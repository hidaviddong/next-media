...
import { useQueueMovies, useScanMovies } from "@/utils";
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    <Drawer open={addFolderDialogOpen} onOpenChange={setAddFolderDialogOpen}>
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            <DrawerTitle>{stepText[step]}</DrawerTitle>
          </DrawerHeader>
            ...
            {step === 3 && (
              <>
                <div className="space-y-2">
                  <div className="grid grid-cols-3 gap-3 items-end">
                    <div className="col-span-2 grid gap-2">
                      <Label htmlFor="cacheCapacityMobile">Capacity</Label>
                      <p className="text-xs text-muted-foreground">
                        Max cache capacity for transcoding, Default: 50 GB
                      </p>
                      <Input
                        id="cacheCapacityMobile"
                        type="number"
                        placeholder="e.g. 50"
                        value={capacityValue}
                        min={1}
