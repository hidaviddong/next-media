...
export type VideoPlayerAirplayButtonProps = ComponentProps<
  typeof MediaAirplayButton
>;

export const VideoPlayerAirplayButton = ({
  className,
  ...props
}: VideoPlayerAirplayButtonProps) => (
  <MediaAirplayButton className={cn("p-2.5", className)} {...props} />
);
